    ...
    describe "Protocol.encode for shapes" $ do
        ...
        describe "Text" $ do
            ...
            it "can encode with start alignment" $ do
                shapeDec (Text (1,2) "CanvasHS" defaults{alignment=Start}) `shouldBe` shapeTextDec "{\"type\": \"text\", \"data\": {\"x\": 1, \"y\": 2, \"fontFamily\": \"Arial\", \"text\": \"CanvasHS\", \"fontSize\": 12, \"fill\": {\"r\":0,\"g\":0,\"b\":0,\"a\":1.0}, \"align\": \"left\", \"bold\": false, \"italic\": false, \"underline\": false}}"
            it "can encode with center alignment" $ do
                shapeDec (Text (1,2) "CanvasHS" defaults{alignment=Center}) `shouldBe` shapeTextDec "{\"type\": \"text\", \"data\": {\"x\": 1, \"y\": 2, \"fontFamily\": \"Arial\", \"text\": \"CanvasHS\", \"fontSize\": 12, \"fill\": {\"r\":0,\"g\":0,\"b\":0,\"a\":1.0}, \"align\": \"center\", \"bold\": false, \"italic\": false, \"underline\": false}}"
            it "can encode with end alignment" $ do
                shapeDec (Text (1,2) "CanvasHS" defaults{alignment=End}) `shouldBe` shapeTextDec "{\"type\": \"text\", \"data\": {\"x\": 1, \"y\": 2, \"fontFamily\": \"Arial\", \"text\": \"CanvasHS\", \"fontSize\": 12, \"fill\": {\"r\":0,\"g\":0,\"b\":0,\"a\":1.0}, \"align\": \"right\", \"bold\": false, \"italic\": false, \"underline\": false}}"
            it "can encode combine all properties" $ do
                shapeDec (Text (1,2) "CanvasHS" defaults{font="comic sans ms", size=10, alignment=End}) `shouldBe` shapeTextDec "{\"type\": \"text\", \"data\": {\"x\": 1, \"y\": 2, \"fontFamily\": \"comic sans ms\", \"text\": \"CanvasHS\", \"fontSize\": 10, \"fill\": {\"r\":0,\"g\":0,\"b\":0,\"a\":1.0}, \"align\": \"right\", \"bold\": false, \"italic\": false, \"underline\": false}}"

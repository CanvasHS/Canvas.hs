    ...
    describe "Protocol.encode for shapes" $ do
        ...
        describe "Text" $ do
            it "can encode simple text" $ do
                shapeDec (Text (1,2) "CanvasHS" defaults) `shouldBe` shapeTextDec "{\"type\": \"text\", \"data\": {\"x\": 1, \"y\": 2, \"fontFamily\": \"Arial\", \"text\": \"CanvasHS\", \"fontSize\": 12, \"fill\": {\"r\":0,\"g\":0,\"b\":0,\"a\":1.0}, \"align\": \"left\", \"bold\": false, \"italic\": false}}"
            it "can encode with different font family" $ do
                shapeDec (Text (1,2) "CanvasHS" defaults{font="comic sans ms"}) `shouldBe` shapeTextDec "{\"type\": \"text\", \"data\": {\"x\": 1, \"y\": 2, \"fontFamily\": \"comic sans ms\", \"text\": \"CanvasHS\", \"fontSize\": 12, \"fill\": {\"r\":0,\"g\":0,\"b\":0,\"a\":1.0}, \"align\": \"left\", \"bold\": false, \"italic\": false}}"
            it "can encode with different font size" $ do
                shapeDec (Text (1,2) "CanvasHS" defaults{size=10}) `shouldBe` shapeTextDec "{\"type\": \"text\", \"data\": {\"x\": 1, \"y\": 2, \"fontFamily\": \"Arial\", \"text\": \"CanvasHS\", \"fontSize\": 10, \"fill\": {\"r\":0,\"g\":0,\"b\":0,\"a\":1.0}, \"align\": \"left\", \"bold\": false, \"italic\": false}}"
            it "can encode with start alignment" $ do
                shapeDec (Text (1,2) "CanvasHS" defaults{alignment=AlignLeft}) `shouldBe` shapeTextDec "{\"type\": \"text\", \"data\": {\"x\": 1, \"y\": 2, \"fontFamily\": \"Arial\", \"text\": \"CanvasHS\", \"fontSize\": 12, \"fill\": {\"r\":0,\"g\":0,\"b\":0,\"a\":1.0}, \"align\": \"left\", \"bold\": false, \"italic\": false}}"
            it "can encode with center alignment" $ do
                shapeDec (Text (1,2) "CanvasHS" defaults{alignment=AlignCenter}) `shouldBe` shapeTextDec "{\"type\": \"text\", \"data\": {\"x\": 1, \"y\": 2, \"fontFamily\": \"Arial\", \"text\": \"CanvasHS\", \"fontSize\": 12, \"fill\": {\"r\":0,\"g\":0,\"b\":0,\"a\":1.0}, \"align\": \"center\", \"bold\": false, \"italic\": false}}"
            it "can encode with end alignment" $ do
                shapeDec (Text (1,2) "CanvasHS" defaults{alignment=AlignRight}) `shouldBe` shapeTextDec "{\"type\": \"text\", \"data\": {\"x\": 1, \"y\": 2, \"fontFamily\": \"Arial\", \"text\": \"CanvasHS\", \"fontSize\": 12, \"fill\": {\"r\":0,\"g\":0,\"b\":0,\"a\":1.0}, \"align\": \"right\", \"bold\": false, \"italic\": false}}"
            it "can encode italics True" $ do
                shapeDec (Text (1,2) "CanvasHS" defaults{italic=True}) `shouldBe` shapeTextDec "{\"type\": \"text\", \"data\": {\"x\": 1, \"y\": 2, \"fontFamily\": \"Arial\", \"text\": \"CanvasHS\", \"fontSize\": 12, \"fill\": {\"r\":0,\"g\":0,\"b\":0,\"a\":1.0}, \"align\": \"left\", \"italic\": true, \"bold\": false}}"
            it "can encode italics False" $ do
                shapeDec (Text (1,2) "CanvasHS" defaults{italic=False}) `shouldBe` shapeTextDec "{\"type\": \"text\", \"data\": {\"x\": 1, \"y\": 2, \"fontFamily\": \"Arial\", \"text\": \"CanvasHS\", \"fontSize\": 12, \"fill\": {\"r\":0,\"g\":0,\"b\":0,\"a\":1.0}, \"align\": \"left\", \"italic\": false, \"bold\": false}}"
            it "can encode bold True" $ do
                shapeDec (Text (1,2) "CanvasHS" defaults{bold=True}) `shouldBe` shapeTextDec "{\"type\": \"text\", \"data\": {\"x\": 1, \"y\": 2, \"fontFamily\": \"Arial\", \"text\": \"CanvasHS\", \"fontSize\": 12, \"fill\": {\"r\":0,\"g\":0,\"b\":0,\"a\":1.0}, \"align\": \"left\", \"bold\": true, \"italic\": false}}"
            it "can encode bold False" $ do
                shapeDec (Text (1,2) "CanvasHS" defaults{bold=False}) `shouldBe` shapeTextDec "{\"type\": \"text\", \"data\": {\"x\": 1, \"y\": 2, \"fontFamily\": \"Arial\", \"text\": \"CanvasHS\", \"fontSize\": 12, \"fill\": {\"r\":0,\"g\":0,\"b\":0,\"a\":1.0}, \"align\": \"left\", \"bold\": false, \"italic\": false}}"
            it "can encode combine all properties" $ do
                shapeDec (Text (1,2) "CanvasHS" defaults{font="comic sans ms",size=10,alignment=AlignRight,bold=True,italic=False}) `shouldBe` shapeTextDec "{\"type\": \"text\", \"data\": {\"x\": 1, \"y\": 2, \"fontFamily\": \"comic sans ms\", \"text\": \"CanvasHS\", \"fontSize\": 10, \"fill\": {\"r\":0,\"g\":0,\"b\":0,\"a\":1.0}, \"align\": \"right\", \"bold\": true, \"italic\": false}}"
        describe "Events" $ do

    ...
    describe "Protocol.encode" $ do
        describe "encodes both shapes and actions" $ do
            ...
            it "can encode Shape without Actions" $ do
                shapeDec (Rect (1,2) 3 4) `shouldBe` shapeTextDec "{\"type\": \"rect\", \"data\": {\"x\": 1, \"y\": 2, \"width\": 3, \"height\": 4}}"
    describe "Protocol.encode for shapes" $ do
        describe "encode basic shapes" $ do
            ...
            it "can encode proper Circles" $ do
                shapeDec (Circle (1,2) 3) `shouldBe` shapeTextDec "{\"type\": \"circle\", \"data\": {\"x\": 1, \"y\": 2, \"radius\": 3}}"
            it "can encode proper Arcs" $ do
                shapeDec (Arc (1, 2) 3 4) `shouldBe` shapeTextDec "{\"type\": \"arc\", \"data\": {\"x\": 1, \"y\": 2, \"radius\": 3, \"angleDeg\":4 }}"
            it "can encode proper Lines" $ do
                shapeDec (Line [(1,2),(3,4),(5,6),(7,8)]) `shouldBe` shapeTextDec "{\"type\": \"line\", \"data\": {\"points\": [1,2,3,4,5,6,7,8]}}"
            it "can encode proper Polygons" $ do
                shapeDec (Polygon [(1,2),(3,4),(5,6),(7,8)]) `shouldBe` shapeTextDec "{\"type\": \"polygon\", \"data\": {\"points\": [1,2,3,4,5,6,7,8]}}"   
        describe "Containers" $ do
            it "can be an empty container" $ do
                shapeDec (Container 1 2 []) `shouldBe` shapeTextDec "{\"type\": \"container\", \"data\": {\"x\": 0, \"y\": 0, \"width\": 1, \"height\": 2}, \"children\":[]}"
            it "can place a basic shape in a container" $ do
                shapeDec (Container 1 2 [(Circle (3,4) 5)]) `shouldBe` shapeTextDec "{\"type\": \"container\", \"data\": {\"x\": 0, \"y\": 0, \"width\": 1, \"height\": 2}, \"children\": [{\"type\": \"circle\", \"data\": {\"x\": 3, \"y\": 4, \"radius\": 5}}]}"
            it "can place basic shapes in a container" $ do
                shapeDec (Container 1 2 [(Circle (3,4) 5), (Rect (6,7) 8 9)]) `shouldBe` shapeTextDec "{\"type\": \"container\", \"data\": {\"x\": 0, \"y\": 0, \"width\": 1, \"height\": 2}, \"children\": [{\"type\": \"circle\", \"data\": {\"x\": 3, \"y\": 4, \"radius\": 5}},{\"type\": \"rect\", \"data\": {\"x\": 6, \"y\": 7, \"width\": 8, \"height\": 9}}]}"
            it "can place containers in containers" $ do
                shapeDec (Container 10 11 [Circle (12,13) 14, Container 1 2 [(Circle (3,4) 5), (Rect (6,7) 8 9)]]) `shouldBe` shapeTextDec "{\"type\": \"container\", \"data\": {\"x\": 0, \"y\": 0, \"width\": 10, \"height\": 11}, \"children\": [{\"type\": \"circle\", \"data\": {\"x\": 12, \"y\": 13, \"radius\": 14}}, {\"type\": \"container\", \"data\": {\"x\": 0, \"y\": 0, \"width\": 1, \"height\": 2}, \"children\": [{\"type\": \"circle\", \"data\": {\"x\": 3, \"y\": 4, \"radius\": 5}},{\"type\": \"rect\", \"data\": {\"x\": 6, \"y\": 7, \"width\": 8, \"height\": 9}}]}]}"
        describe "Fill" $ do
        ...
        describe "Stroke" $ do
            it "can add stroke to a basic shape" $ do
                shapeDec (Stroke (4,5,6,0.5) 1 (Rect (1,2) 3 4)) `shouldBe` shapeTextDec "{\"type\": \"rect\", \"data\": {\"x\": 1, \"y\": 2, \"width\": 3, \"height\": 4, \"stroke\": {\"r\":4,\"g\":5,\"b\":6,\"a\":0.5}, \"strokeWidth\": 1}}"
            it "can recursively add stroke on a container and its contents" $ do
                shapeDec (Stroke (4,5,6,0.5) 1 (Container 10 11 [Circle (12,13) 14, Container 1 2 [(Circle (3,4) 5), (Rect (6,7) 8 9)]])) `shouldBe` shapeTextDec "{\"type\": \"container\", \"data\": {\"x\": 0, \"y\": 0, \"width\": 10, \"height\": 11, \"stroke\": {\"r\":4,\"g\":5,\"b\":6,\"a\":0.5}, \"strokeWidth\": 1}, \"children\": [{\"type\": \"circle\", \"data\": {\"x\": 12, \"y\": 13, \"radius\": 14, \"stroke\": {\"r\":4,\"g\":5,\"b\":6,\"a\":0.5}, \"strokeWidth\": 1}}, {\"type\": \"container\", \"data\": {\"x\": 0, \"y\": 0, \"width\": 1, \"height\": 2, \"stroke\": {\"r\":4,\"g\":5,\"b\":6,\"a\":0.5}, \"strokeWidth\": 1}, \"children\": [{\"type\": \"circle\", \"data\": {\"x\": 3, \"y\": 4, \"radius\": 5, \"stroke\": {\"r\":4,\"g\":5,\"b\":6,\"a\":0.5}, \"strokeWidth\": 1}},{\"type\": \"rect\", \"data\": {\"x\": 6, \"y\": 7, \"width\": 8, \"height\": 9, \"stroke\": {\"r\":4,\"g\":5,\"b\":6,\"a\":0.5}, \"strokeWidth\": 1}}]}]}"
        describe "Rotate" $ do
            it "can rotate a basic shape" $ do
                shapeDec (Rotate 4 (Circle (1,2) 3)) `shouldBe` shapeTextDec "{\"type\": \"circle\", \"data\": {\"x\": 1, \"y\": 2, \"radius\": 3, \"rotationDeg\": 4}}"
            it "can rotate a container" $ do
                shapeDec (Rotate 4 (Container 1 2 [(Circle (3,4) 5)])) `shouldBe` shapeTextDec "{\"type\": \"container\", \"data\": {\"x\": 0, \"y\": 0, \"width\": 1, \"height\": 2, \"rotationDeg\": 4}, \"children\": [{\"type\": \"circle\", \"data\": {\"x\": 3, \"y\": 4, \"radius\": 5}}]}"
            it "can rotate a negative angle" $ do
                shapeDec (Rotate (-4) (Circle (1,2) 3)) `shouldBe` shapeTextDec "{\"type\": \"circle\", \"data\": {\"x\": 1, \"y\": 2, \"radius\": 3, \"rotationDeg\": -4}}"    
        describe "Translate" $ do
            it "can translate a basic shape" $ do
                shapeDec (Translate 10 20 (Rect (1,2) 3 4)) `shouldBe` shapeTextDec "{\"type\": \"rect\", \"data\": {\"x\": 11, \"y\": 22, \"width\": 3, \"height\": 4}}"
        ...
        describe "Scale" $ do
            ...
            it "can scale containers" $ do
                shapeDec (Scale 2.0 0.5 (Container 1 2 [(Circle (3,4) 5)])) `shouldBe` shapeTextDec "{\"type\": \"container\", \"data\": {\"x\": 0, \"y\": 0, \"width\": 1, \"height\": 2, \"scaleX\": 2.0, \"scaleY\": 0.5}, \"children\": [{\"type\": \"circle\", \"data\": {\"x\": 3, \"y\": 4, \"radius\": 5}}]}"
        describe "Offset" $ do
            it "can set offset on a basic shape" $ do
                shapeDec (Offset (5,6) (Rect (1,2) 3 4)) `shouldBe` shapeTextDec "{\"type\": \"rect\", \"data\": {\"x\": 1, \"y\": 2, \"width\": 3, \"height\": 4, \"offset\": [5,6]}}"
            it "can set offset on a container" $ do
                shapeDec (Offset (5,6) (Container 1 2 [(Circle (3,4) 5)])) `shouldBe` shapeTextDec "{\"type\": \"container\", \"data\": {\"x\": 0, \"y\": 0, \"width\": 1, \"height\": 2, \"offset\": [5,6]}, \"children\": [{\"type\": \"circle\", \"data\": {\"x\": 3, \"y\": 4, \"radius\": 5}}]}"
        describe "Text" $ do
            it "can encode simple text" $ do
                shapeDec (Text (1,2) "CanvasHS" defaults) `shouldBe` shapeTextDec "{\"type\": \"text\", \"data\": {\"x\": 1, \"y\": 2, \"fontFamily\": \"Arial\", \"text\": \"CanvasHS\", \"fontSize\": 12, \"align\": \"left\", \"bold\": false, \"italic\": false, \"underline\": false}}"
            it "can encode with different font family" $ do
                shapeDec (Text (1,2) "CanvasHS" defaults{font="comic sans ms"}) `shouldBe` shapeTextDec "{\"type\": \"text\", \"data\": {\"x\": 1, \"y\": 2, \"fontFamily\": \"comic sans ms\", \"text\": \"CanvasHS\", \"fontSize\": 12, \"align\": \"left\", \"bold\": false, \"italic\": false, \"underline\": false}}"
            it "can encode with different font size" $ do
                shapeDec (Text (1,2) "CanvasHS" defaults{size=10}) `shouldBe` shapeTextDec "{\"type\": \"text\", \"data\": {\"x\": 1, \"y\": 2, \"fontFamily\": \"Arial\", \"text\": \"CanvasHS\", \"fontSize\": 10, \"align\": \"left\", \"bold\": false, \"italic\": false, \"underline\": false}}"
            it "can encode with start alignment" $ do
                shapeDec (Text (1,2) "CanvasHS" defaults{alignment=AlignLeft}) `shouldBe` shapeTextDec "{\"type\": \"text\", \"data\": {\"x\": 1, \"y\": 2, \"fontFamily\": \"Arial\", \"text\": \"CanvasHS\", \"fontSize\": 12, \"align\": \"left\", \"bold\": false, \"italic\": false, \"underline\": false}}"
            it "can encode with center alignment" $ do
                shapeDec (Text (1,2) "CanvasHS" defaults{alignment=AlignCenter}) `shouldBe` shapeTextDec "{\"type\": \"text\", \"data\": {\"x\": 1, \"y\": 2, \"fontFamily\": \"Arial\", \"text\": \"CanvasHS\", \"fontSize\": 12, \"align\": \"center\", \"bold\": false, \"italic\": false, \"underline\": false}}"
            it "can encode with end alignment" $ do
                shapeDec (Text (1,2) "CanvasHS" defaults{alignment=AlignRight}) `shouldBe` shapeTextDec "{\"type\": \"text\", \"data\": {\"x\": 1, \"y\": 2, \"fontFamily\": \"Arial\", \"text\": \"CanvasHS\", \"fontSize\": 12, \"align\": \"right\", \"bold\": false, \"italic\": false, \"underline\": false}}"
            it "can encode underline True" $ do
                shapeDec (Text (1,2) "CanvasHS" defaults{underline=True}) `shouldBe` shapeTextDec "{\"type\": \"text\", \"data\": {\"x\": 1, \"y\": 2, \"fontFamily\": \"Arial\", \"text\": \"CanvasHS\", \"fontSize\": 12, \"align\": \"left\", \"underline\": true, \"bold\": false, \"italic\": false}}"
            it "can encode underline False" $ do
                shapeDec (Text (1,2) "CanvasHS" defaults{underline=False}) `shouldBe` shapeTextDec "{\"type\": \"text\", \"data\": {\"x\": 1, \"y\": 2, \"fontFamily\": \"Arial\", \"text\": \"CanvasHS\", \"fontSize\": 12, \"align\": \"left\", \"underline\": false, \"bold\": false, \"italic\": false}}"
            it "can encode italics True" $ do
                shapeDec (Text (1,2) "CanvasHS" defaults{italic=True}) `shouldBe` shapeTextDec "{\"type\": \"text\", \"data\": {\"x\": 1, \"y\": 2, \"fontFamily\": \"Arial\", \"text\": \"CanvasHS\", \"fontSize\": 12, \"align\": \"left\", \"italic\": true, \"bold\": false, \"underline\": false}}"
            it "can encode italics False" $ do
                shapeDec (Text (1,2) "CanvasHS" defaults{italic=False}) `shouldBe` shapeTextDec "{\"type\": \"text\", \"data\": {\"x\": 1, \"y\": 2, \"fontFamily\": \"Arial\", \"text\": \"CanvasHS\", \"fontSize\": 12, \"align\": \"left\", \"italic\": false, \"bold\": false, \"underline\": false}}"
            it "can encode bold True" $ do
                shapeDec (Text (1,2) "CanvasHS" defaults{bold=True}) `shouldBe` shapeTextDec "{\"type\": \"text\", \"data\": {\"x\": 1, \"y\": 2, \"fontFamily\": \"Arial\", \"text\": \"CanvasHS\", \"fontSize\": 12, \"align\": \"left\", \"bold\": true, \"underline\": false, \"italic\": false}}"
            it "can encode bold False" $ do
                shapeDec (Text (1,2) "CanvasHS" defaults{bold=False}) `shouldBe` shapeTextDec "{\"type\": \"text\", \"data\": {\"x\": 1, \"y\": 2, \"fontFamily\": \"Arial\", \"text\": \"CanvasHS\", \"fontSize\": 12, \"align\": \"left\", \"bold\": false, \"underline\": false, \"italic\": false}}"
            it "can encode bold, underline and italic combined" $ do
                shapeDec (Text (1,2) "CanvasHS" defaults{bold=True,underline=True,italic=False}) `shouldBe` shapeTextDec "{\"type\": \"text\", \"data\": {\"x\": 1, \"y\": 2, \"fontFamily\": \"Arial\", \"text\": \"CanvasHS\", \"fontSize\": 12, \"align\": \"left\", \"bold\": true, \"italic\": false, \"underline\": true}}"
            it "can encode combine all properties" $ do
                shapeDec (Text (1,2) "CanvasHS" defaults{font="comic sans ms",size=10,alignment=AlignRight,bold=True,underline=True,italic=False}) `shouldBe` shapeTextDec "{\"type\": \"text\", \"data\": {\"x\": 1, \"y\": 2, \"fontFamily\": \"comic sans ms\", \"text\": \"CanvasHS\", \"fontSize\": 10, \"align\": \"right\", \"bold\": true, \"italic\": false, \"underline\": true}}"
        describe "Events" $ do
            it "can add an event to a shape" $ do
                shapeDec (Event defaults{eventId="circle1", mouseClick=True} (Circle (1,2) 3)) `shouldBe` shapeTextDec "{\"type\": \"circle\", \"data\": {\"x\": 1, \"y\": 2, \"radius\": 3}, \"eventData\": {\"eventId\": \"circle1\", \"listen\": [\"mouseclick\"]}}"
            it "can add multiple events to a shape" $ do
                shapeDec (Event defaults{eventId="circle1", mouseDown=True, mouseClick=True, mouseUp=True, mouseDoubleClick=True, mouseDrag=True, mouseOver=True, mouseOut=True, scroll=True} (Circle (1,2) 3)) `shouldBe` shapeTextDec "{\"type\": \"circle\", \"data\": {\"x\": 1, \"y\": 2, \"radius\": 3}, \"eventData\": {\"eventId\": \"circle1\", \"listen\": [\"mousedown\", \"mouseclick\", \"mouseup\", \"mousedoubleclick\", \"mousedrag\", \"mouseover\", \"mouseout\", \"scroll\"]}}"
            it "can add events to a container" $ do
                shapeDec (Event defaults{eventId="container1", mouseClick=True, mouseDrag=True} (Container 1 2 [(Circle (3,4) 5)])) `shouldBe` shapeTextDec "{\"type\": \"container\", \"data\": {\"x\": 0, \"y\": 0, \"width\": 1, \"height\": 2}, \"eventData\": {\"eventId\": \"container1\", \"listen\": [\"mouseclick\", \"mousedrag\"]}, \"children\": [{\"type\": \"circle\", \"data\": {\"x\": 3, \"y\": 4, \"radius\": 5}}]}"

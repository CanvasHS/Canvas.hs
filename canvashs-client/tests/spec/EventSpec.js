...
describe("Draw elements to test event handling", function() {
  ...
  it("testing message after mousedrag event", function() {
    ...
    expect(connection.send).toHaveBeenCalledWith('{"event":"mousedrag","data":{"id":"circle_nr_2","x1":120,"y1":70,"x2":200,"y2":250}}');
...
describe("Test realX and realY functions", function() {
  var flag;
  var canvas;
  beforeEach(function(){
    // Setup canvas of Canvas.Hs

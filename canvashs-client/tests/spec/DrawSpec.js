...
describe("Draw elements", function() {
    ...
    it("draws a line", function() {
        runs(function() {
            ...
            connectionDataReceived({"data": '{"shape":{"type": "line","data": {"id": "line_1","points": [10,0,10,20], "stroke": {"r":255,"g":255,"b":255,"a":1},"strokeWidth": 2}}}'});
            stage.batchDraw();
            stage.draw();
        });
        runs(function() {
...
describe("Draw elements", function() {
	...
	beforeEach(function(){
  	...
  	it("draws a polygon", function() {
  		...
  		runs(function() {
  			// Draw in the comparison Canvas, draws counter clockwise rotation
  			layer = compare_stage.getChildren().toArray()[0];
	 		var poly = new Kinetic.Polygon({
		        points: [73, 192, 73, 160, 340, 23, 500, 109, 499, 139, 342, 93],
		        fill: 'rgba(255,100,100,1)',
